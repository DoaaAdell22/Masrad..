  ...
  return (
    <div className="container p-5 mx-auto ">
        <div className="bg-[#0C5685] flex flex-col-reverse md:flex-row md:items-center  gap-4 rounded-3xl p-6">
            <img src="/landing.png" className="lg:w-[60%] md:w-[70%] w-full  md:h-[450px] h-[250px]  m-[-24px] " />
            <div className=" md:text-end md:w-[40%]  text-center ">
                ...
                <button className="bg-[#FCD275] text-[15px] font-bold text-[#0C5685] lg:py-4 lg:px-8 p-3 my-4   rounded-xl ">اعرف اكتر عن المسرد</button>
            </div>
        </div>
    </div>
  )
