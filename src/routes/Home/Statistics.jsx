  ...
  return (
    <div className="container mx-auto p-5 ">
        ...
        <div className="grid xl:grid-cols-4   md:grid-cols-2 grid-cols-1 gap-6 justify-center sm:text-end  items-center my-5 ">
            ...
            <div className="flex flex-col gap-4 justify-center sm:items-end items-center">
                <span className="text-[#D08A40] lg:text-[48px] text-[30px] font-medium">10+</span>
                <p className="text-[#0C5685] text-[19px] font-bold">   سنوات من الخبره في خدمتكم</p>
                <div className="w-[260px] h-[1px] bg-[#FCD275]"></div>
            </div>
            <div className="flex flex-col gap-4 justify-center sm:items-end items-center">
                <span className="text-[#D08A40] lg:text-[48px] text-[30px] font-medium">2500+</span>
                <p className="text-[#0C5685] text-[19px] font-bold">مشروع تم إنجازه في مسرد</p>
                <div className="w-[260px] h-[1px] bg-[#FCD275]"></div>
            </div>
            <div className="flex flex-col gap-4 justify-center sm:items-end items-center">
                <span className="text-[#D08A40] lg:text-[48px] text-[30px] font-medium">120+</span>
