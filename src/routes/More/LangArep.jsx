    ...
    <div className="bg-[#0C5685]">
        <div className=" container  mx-auto   flex flex-col-reverse justify-between items-center md:flex-row  gap-10 rounded-3xl px-5 py-10 ">
            ...
            <div className=" md:text-end  flex flex-col gap-5 justify-center md:items-end items-center text-center font-bold lg:w-[60%] md:w-[50%] ">
                ...
                <h1 className=" lg:text-[28px] md:text-[20px] text-[18px] text-[white] leading-10">     قائمة من الالفاظ المستعملة في اصطلاح معين وتعاريفها, وسمي كذلك لان الالفاظ تسرد فيه اي تتابع.</h1>
                <div className=" flex flex-col-reverse md:flex-row gap-4 font-bold text-[19px]  justify-center items-center">    
                    ...
                    <div className="bg-[rgba(252,210,117,0.2)] md:w-16 md:h-16 w-14 h-14 rounded-xl flex justify-center items-center"><img src="/voice.png" className="md:w-10 md:h-10 w-8 h-8 "  /></div>
                </div>
                <div className=" flex flex-col-reverse md:flex-row gap-4 font-bold text-[19px] text-[white]  justify-center items-center">
                    ...
                    <div className="bg-[rgba(252,210,117,0.2)] md:w-16 md:h-16 w-14 h-14 rounded-xl flex justify-center items-center"><img src="/echo.png" className="md:w-10 md:h-10 w-8 h-8 "  /></div>
